        ...
        <>
            ...
            <div name='home' className='w-full h-screen bg-black flex flex-col justify-between'>
                <div className='grid md:grid-cols-2 max-w-[1240px] m-auto'>
                    <div className='flex flex-col justify-center md:items-start w-full px-2 py-8'>
                        <h1 className='py-3 text-5xl md:text-6xl font-bold text-white'>IMAGE ANNOTATION SERVICES</h1>
                        <p className='text-xl'>We delivers stellar image annotation services that power AI, machine learning, and data operation strategies.</p>
                    </div>
                    <div>
            ...
            <section className="bg-Black">
                <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
                    <div className="font-light text-gray-500 sm:text-lg dark:text-gray-400">
                        <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">What is Image Annotation ?</h2>
                        ...
                        <p>Successful image annotation projects involving computer vision are built on high-quality annotation. The type of annotation needed will depend on the use case the project is designed for.</p>
                    </div>
                    <div className="grid grid-cols-2 gap-4 mt-8">
                        <img className="w-full rounded-lg" src={bgImg2} alt="office content 1" />
                        <img className="mt-4 w-full lg:mt-10 rounded-lg" src={bgImg3} alt="office content 2" />
                    </div>
                </div>
            </section>
                    ...
                    <div className="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
                        <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-900 dark:border-gray-700">
                            <a href="#" className='w-full'>
                                <img className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src={bgImg12} alt="Bonnie Avatar" />
                            </a>
                            <div className="p-5 w-full">
                                <h3 className="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                                    <a href="#">BOUNDING BOXES</a>
                                </h3>
                                <p className="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">The simplicity of bounding boxes is exactly their strength, making this method of image annotation applicable for a wide range of uses.</p>

                            </div>
                        </div>
                        <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-900 dark:border-gray-700">
                            <a href="#" className='w-full'>
                                <img className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src={bgImg11} alt="Jese Avatar" />
                            </a>
                            <div className="p-5 w-full">
                                <h3 className="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                                    <a href="#">POLYGON ANNOTATION</a>
                                </h3>
                                <p className="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">This technique is especially useful in computer vision as annotators can use it to identify irregular shapes, allowing computers to identify and respond to them.</p>
                        ...
                        <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-900 dark:border-gray-700">
                            ...
                            <div className="p-5 w-full">
                                ...
                                <p className="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">The expert semantic segmentation, data can be organized in multiple formats for AI models across a variety of use cases.</p>
                            </div>
                        </div>
                        <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-900 dark:border-gray-700">
                            <a href="#" className='w-full'>
                            ...
                            <div className="p-5 w-full">
                                <h3 className="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                                    <a href="#">LIDAR ANNOTATION</a>
                                </h3>
                                <p className="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">The high-quality ground truth datasets for use in computer vision models such as autonomous vehicles.</p>
                            </div>
                        </div>
                        <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-900 dark:border-gray-700">
                            <a href="#" className='w-full'>
                                <img className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src={bgImg15} alt="Michael Avatar" />
                            </a>
                            <div className="p-5 w-full">
                                <h3 className="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                                    <a href="#">IMAGE CLASSIFICATION</a>
                                </h3>
                                <p className="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">Expert image classification turns image data into image insights for AI and ML models.</p>
                            </div>
                        </div>
                        <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-900 dark:border-gray-700">
                            <a href="#" className='w-full'>
                                <img className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src={bgImg16} alt="Sofia Avatar" />
                            </a>
                            <div className="p-5 w-full">
                                <h3 className="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                                    <a href="#">3D CUBOID ANNOTATION</a>
                                </h3>
                                <p className="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">We can generate training datasets to teach machine learning models to recognize the depth of objects. </p>
                            </div>
                        </div>
                        <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-900 dark:border-gray-700">
                            <a href="#" className='w-full'>
                                <img className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src={bgImg17} alt="Michael Avatar" />
                            </a>
                            <div className="p-5 w-full">
                                <h3 className="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                                    <a href="#">KEYPOINT ANNOTATION</a>
                                </h3>
                                <p className="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">This annotation type detects body features and could include facial expressions and emotions.</p>
                            </div>
                        </div>
                        <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-900 dark:border-gray-700">
                            <a href="#" className='w-full'>
                                <img className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src={bgImg18} alt="Sofia Avatar" />
                            </a>
                            <div className="p-5 w-full">
                                <h3 className="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                                    <a href="#">POLYLINE ANNOTATION</a>
                                </h3>
                                <p className="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">Popular use cases include autonomous vehicles and teaching them road boundaries.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="bg-black">
                <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                    <div className="max-w-screen mb-8">
                        <h1 className='text-center text-4xl font-bold text-white'>What Industries Need Image Annotation Services?</h1>
                    </div><br /><br />
                    <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                        <div>
                            ...
                            <h3 className="mb-2 text-xl font-bold dark:text-white">Autonomous Technology & Transportation</h3>
                            <p className="text-gray-500 dark:text-gray-400">Image annotation services can help in the deployment of autonomous technology through labeling of images of a car’s environment.</p>
                        </div>
                        <div>
                            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-red-700 lg:h-12 lg:w-12 dark:bg-primary-900">
                            ...
                            <h3 className="mb-2 text-xl font-bold dark:text-white">Medical AI</h3>
                            <p className="text-gray-500 dark:text-gray-400">Medical image annotation includes the labeling of medical imaging data to diagnose diseases and spot abnormalities.</p>
                        </div>
                        <div>
                            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-red-700 lg:h-12 lg:w-12 dark:bg-primary-900">
                            ...
                            <h3 className="mb-2 text-xl font-bold dark:text-white">Commerce</h3>
                            <p className="text-gray-500 dark:text-gray-400">With image annotation in commerce, experts categorize e-commerce content by multiple attributes to improve search relevance and customer experience for online shopper</p>
                        </div>
                        <div>
                            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-red-700 lg:h-12 lg:w-12 dark:bg-primary-900">
                            ...
                            <h3 className="mb-2 text-xl font-bold dark:text-white">Geospatial Technology</h3>
                            <p className="text-gray-500 dark:text-gray-400">Image annotation tasks include extracting intelligence from satellite, aerial, and drone imagery to power applications in energy, agriculture, logistics, security and mapping.</p>
                        </div>
                        <div>
                            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-red-700 lg:h-12 lg:w-12 dark:bg-primary-900">
                            ...
                            <h3 className="mb-2 text-xl font-bold dark:text-white">Finance & Insurance Tech</h3>
                            <p className="text-gray-500 dark:text-gray-400">Image annotation experts extract and organize relevant material from vast sets of unstructured visual data to enable the automation of manual processes and streamlining of operations.</p>
                        </div>
                        <div>
                            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-red-700 lg:h-12 lg:w-12 dark:bg-primary-900">
                            ...
                            <h3 className="mb-2 text-xl font-bold dark:text-white">Government</h3>
                            <p className="text-gray-500 dark:text-gray-400">Image annotation experts in the public sector offer a solution for sensitive data that requires processing at the federal, state, and local levels.</p>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-6">
                    <dl className="grid max-w-screen-md gap-8 mx-auto text-gray-900 sm:grid-cols-3 dark:text-white">
                        <div className="flex flex-col items-center justify-center">
                            ...
                            <dd className="font-light text-gray-500 dark:text-gray-400">Image Annotation</dd>
                        </div>
                        <div className="flex flex-col items-center justify-center">
                            <dt className="mb-2 text-3xl md:text-4xl font-extrabold">95%</dt>
                            <dd className="font-light text-gray-500 dark:text-gray-400">Accuracy</dd>
                        </div>
                        <div className="flex flex-col items-center justify-center">
            ...
            <section className="bg-black">
                <div className="py-8 lg:py-16 mx-auto max-w-screen-xl px-4">
                    <h2 className="mb-8 lg:mb-16 text-3xl font-bold tracking-tight leading-tight text-center text-gray-900 dark:text-white md:text-4xl">Image Annotation Services To AI Leads</h2>
                    <div className="grid grid-cols-2 gap-8 text-white sm:gap-12 md:grid-cols-3 lg:grid-cols-6 dark:text-white">
            ...
            <section className="bg-black flex justify-center flex-col items-center w-full pl-16">
                <h2 className="mb-8 lg:mb-16 text-3xl font-bold tracking-tight leading-tight text-center text-gray-900 dark:text-white md:text-4xl">Image Annotation Use Case</h2>
                <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                    <div className="hidden lg:mt-0 lg:col-span-5 lg:flex">
                        <img src={bgImg4} alt="mockup" />
                    </div>&nbsp;
                    <div className="mr-auto place-self-center lg:col-span-5">
                        <h1 className="max-w-2xl mb-4 text-2xl font-bold tracking-tight leading-none md:text-3xl xl:text-4xl dark:text-white">IMAGE ANNOTATION TOOL FOR SPORTS AI</h1>
                        <p className="max-w-xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">iMerit has developed a customized end-to-end workflow for its engagement with KinaTrax, leveraging its proprietary tools and technology as well as the expertise of its experienced computer vision teams. Our expert labelers extract still images from in-game video footage of the players captured from numerous angles. The images are annotated precisely based on KinaTrax’s requirements.</p>
                    </div>
                </div>

                <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                    <div className="mr-auto place-self-center lg:col-span-5">
                        <h1 className="max-w-2xl mb-4 text-2xl font-bold tracking-tight leading-none md:text-3xl xl:text-4xl dark:text-white">SEMANTIC SEGMENTATION FOR AUTONOMOUS VEHICLES</h1>
                        <p className="max-w-xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">iMerit employs a team of visual data experts who have performed image annotation on up to 100,000 street images for a client who is a leading global automobile manufacturer and a major contender in the autonomous vehicle segment. The iMerit team has annotated the elements in the images into predetermined classes of objects, ultimately dividing the image into semantically meaningful parts, to train the machine learning algorithm not just to ‘see’ but also to understand and interpret its environment and accuracy.</p>
                    </div>&nbsp;
                    <div className="hidden lg:mt-0 lg:col-span-5 lg:flex">
                        <img src={bgImg5} alt="mockup" />
                    </div>
                </div>

                <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                    <div className="hidden lg:mt-0 lg:col-span-5 lg:flex">
                        <img src={bgImg6} alt="mockup" />
                    </div>&nbsp;
                    <div className="mr-auto place-self-center lg:col-span-5">
                        <h1 className="max-w-2xl mb-4 text-2xl font-bold tracking-tight leading-none md:text-3xl xl:text-4xl dark:text-white">DETECTING OPERATING BOUNDARIES WITH POLYLINE ANNOTATION</h1>
                        <p className="max-w-xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">iMerit experts will comb through each pixel of an image using the iMerit proprietary annotation platform to teach a vehicle to accurately detect and identify lines and splines such as street lanes, road markings, directions, divergence, and traffic.</p>
                    </div>
                </div>

                <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                    <div className="mr-auto place-self-center lg:col-span-5">
                        <h1 className="max-w-2xl mb-4 text-2xl font-bold tracking-tight leading-none md:text-3xl xl:text-4xl dark:text-white">BOUNDING BOXES FOR BETTER DATA EXTRACTION</h1>
                        <p className="max-w-xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">To improve the performance of their proprietary tax software, this company worked asked iMerit to annotate a series of documents using bounding boxes. This taught the algorithm to see and automatically extract the numbers that were in the fields on the documentation, sparing users from manual entry and automating and otherwise time-consuming process.</p>
                    </div>&nbsp;
                    <div className="hidden lg:mt-0 lg:col-span-5 lg:flex">
                        <img src={bgImg7} alt="mockup" />
                    </div>
                </div>

                <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                    <div className="hidden lg:mt-0 lg:col-span-5 lg:flex">
                        <img src={bgImg9} alt="mockup" />
                    </div>&nbsp;
                    <div className="mr-auto place-self-center lg:col-span-5">
                        <h1 className="max-w-2xl mb-4 text-2xl font-bold tracking-tight leading-none md:text-3xl xl:text-4xl dark:text-white">3D CUBOIDS FOR ROBOTIC AUTOMATION</h1>
                        <p className="max-w-xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">Through the use of 2D and 3D cuboids, iMerit experts are teaching robots in warehouses, factories, and other sorting and manufacturing facilities how to see and interact with objects. This helps further AI in robotics by allowing the robots to identify the dimensions of a given object, and interact with them accordingly to carry out a certain goal.</p>
                    </div>
                </div>

                <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                    <div className="mr-auto place-self-center lg:col-span-5">
                        <h1 className="max-w-2xl mb-4 text-2xl font-bold tracking-tight leading-none md:text-3xl xl:text-4xl dark:text-white">CREATE LARGER HARVEST YIELDS WITH COMPUTER VISION</h1>
                        <p className="max-w-xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">Farmers use computer vision to monitor their crops for pests and plant diseases. Through the use of images collected by drones, iMerit experts can teach a model to recognize pests and potential threats to crop fields by annotating every pixel of a given image.</p>
                    </div>&nbsp;
                    <div className="hidden lg:mt-0 lg:col-span-5 lg:flex">
                        <img src={bgImg8} alt="mockup" />
                    </div>
                </div>

                <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                    <div className="hidden lg:mt-0 lg:col-span-5 lg:flex">
                        <img src={bgImg10} alt="mockup" />
                    </div>&nbsp;
                    <div className="mr-auto place-self-center lg:col-span-5">
                        <h1 className="max-w-2xl mb-4 text-2xl font-bold tracking-tight leading-none md:text-3xl xl:text-4xl dark:text-white">FACIAL RECOGNITION USING KEYPOINT ANNOTATION</h1>
                        <p className="max-w-xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">Farmers use computer vision to monitor their crops for pests and plant diseases. Through the use of images collected by drones, iMerit experts can teach a model to recognize pests and potential threats to crop fields by annotating every pixel of a given image.</p>
                    </div>
                </div>
                ...
                <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
                    <div className="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
                        <h2 className="mb-4 text-3xl tracking-tight font-bold text-gray-900 dark:text-white">Getting Starting With Image Annotation</h2>
                        <p className="font-light text-gray-500 lg:mb-16 sm:text-xl dark:text-gray-400">iMerit annotation experts apply keypoints on a face, taking care to apply them to key locations such as the eyes, nose, and mouth. This allows iMerit to create world-class training datasets for use in facial recognition models. This advanced technology is helping in public areas where crimes occur to identity and apprehend perpetrators.</p>
                        <a href="#" className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-gray-900 border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-red-700 dark:focus:ring-gray-800">Talk To An Expect</a>
                    </div>
                </div>
