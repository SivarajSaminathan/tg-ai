    ...
    <section className="bg-black">
                <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
                    <div className="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
                        <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">{props.heading}{/*Image Annotation Services*/}</h2>
                        <p className="font-light text-gray-500 lg:mb-16 sm:text-xl dark:text-gray-400">{props.text}{/*Explore the whole collection of open-source web components and elements built with the utility classNamees from Tailwind*/}</p>
                    </div>
                    <div className="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
                        <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-900 dark:border-gray-700">
                            ...
                            <div className="p-5 w-full">
                                ...
                                <p className="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">{props.text1}</p>
                        ...
                        <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-900 dark:border-gray-700">
                            ...
                            <div className="p-5 w-full">
                                ...
                                <p className="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">{props.text2}</p>
                        ...
                        <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-900 dark:border-gray-700">
                            ...
                            <div className="p-5 w-full">
                                ...
                                <p className="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">{props.text3}</p>
                            </div>
                        </div>
                        <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-900 dark:border-gray-700">
                            <a href="#" className='w-full'>
                            ...
                            <div className="p-5 w-full">
                                ...
                                <p className="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">{props.text4}</p>
                            </div>
                        </div>
                        <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-900 dark:border-gray-700">
                            <a href="#" className='w-full'>
                            ...
                            <div className="p-5 w-full">
                                ...
                                <p className="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">{props.text5}</p>
                            </div>
                        </div>
                        <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-900 dark:border-gray-700">
                            <a href="#" className='w-full'>
                            ...
                            <div className="p-5 w-full">
                                ...
                                <p className="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">{props.text6}</p>
                            </div>
                        </div>
                        <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-900 dark:border-gray-700">
                            <a href="#" className='w-full'>
                            ...
                            <div className="p-5 w-full">
                                ...
                                <p className="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">{props.text7}</p>
                            </div>
                        </div>
                        <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-900 dark:border-gray-700">
                            <a href="#" className='w-full'>
                            ...
                            <div className="p-5 w-full">
                                ...
                                <p className="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">{props.text8}</p>
                            </div>
                        </div>
                    </div>
                </div>
